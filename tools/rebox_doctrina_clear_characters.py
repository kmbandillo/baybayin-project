#!/usr/bin/env python3
"""Rebuild Doctrina Clear character .box files using the Bagwis component method."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Rebox Doctrina Clear character datasets using the Bagwis component method."
    )
    parser.add_argument(
        "--root",
        type=Path,
        default=Path("dataset/characters/doctrina_clear_characters"),
        help="Directory that holds rendered Doctrina Clear characters.",
    )
    parser.add_argument(
        "--threshold",
        type=int,
...
def main() -> None:
    ...
    print(f"Reboxed {success}/{total} Doctrina Clear samples{suffix}.")
